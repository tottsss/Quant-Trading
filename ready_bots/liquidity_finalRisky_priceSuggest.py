...
REPORT_PREFIX = _env("RIT_FINAL_RISKY_REPORT_PREFIX", "RIT_FINAL_REPORT_PREFIX", "liquidity_finalRisky_priceSuggest_report")
...
def _effective_accept_params(attempt_idx):
    eff_edge = MIN_EDGE
...
def _action_edge_ok(action, tender_price, vwap_bid, vwap_ask, bid_volume, ask_volume, attempt_idx):
    ...
    """
    eff_edge, eff_vol_factor = _effective_accept_params(attempt_idx)
...
def evaluate_tender(session, tender):
    ...
    for i in range(attempts):
        ...
        if is_fixed:
            ...
            eff_edge, eff_vol_factor = _effective_accept_params(i)
